...
export type ArchiveTemplate = ContentTemplate & {
  __typename?: 'ArchiveTemplate';
...
export enum MediaItemSizeEnum {
  ...
  /** MediaItem with the post-image size */
  PostImage = 'POST_IMAGE',
  /** MediaItem with the post-thumb size */
...
export type WpPostPreviewQueryVariables = Exact<{ [key: string]: never; }>;


export type WpPostPreviewQuery = (
  { __typename?: 'RootQuery' }
  & { posts?: Maybe<(
    { __typename?: 'RootQueryToPostConnection' }
